The Elk River PRMS Model was calibrated to provide unimpaired modeled flow estimates at a subbasin scale and has a model run time from October 1, 1981 to May 31, 2023. Files generally needed for a PRMS model to run include a control file, data file, parameter file, model executable, and batch file. Executing the model per the directions outlined in this read me will produce daily flows for the entire time period.

The control file is called 'elk_river_control.control' 
The data file is called 'elk_river_data.data'
The parameter file is called: 'elk_river_param.params'
